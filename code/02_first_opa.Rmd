...
est_billionares_in_f <- function(evasion_param_var = evasion_param_in, wealth_last_400_var = wealth_last_400_so,
    ...
    top_tax_base_in <- final_taxbase_b_in * 0.01
    ...
    return( list( "non_evaded_tax_in" = non_evaded_tax_in, "totax_last_400_in" = totax_last_400_in, 
                  "totax_average_400_in" = totax_average_400_in, "totax_total_400_in" = totax_total_400_in, 
                  "pareto_scale_in" = pareto_scale_in, "ratio1_in" = ratio1_in, "missing_fraction_in" = missing_fraction_in, 
                  "missing_taxbase_in" = missing_taxbase_in, "num_billionares_in" = num_billionares_in, 
                  "final_taxbase_b_in" = final_taxbase_b_in, "top_tax_base_in" = top_tax_base_in, "cum_numberTaxpayers_scf_in" = 
                    cum_numberTaxpayers_scf_in, "cum_numberTaxpayers_dina_in" = cum_numberTaxpayers_dina_in, 
                  "cum_tax_base_scf_in" = cum_tax_base_scf_in, "cum_tax_base_dina_in" = cum_tax_base_dina_in ) )
}
