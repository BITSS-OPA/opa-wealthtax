...
** 1 - Download/Clone the repository ([Click here/ADD URL WHEN ALLOWED](NULL)) into your computer. You will need to install R and RStudio. **
** 2 - Go to this link [Click here/ADD URL WHEN ALLOWED](NULL) and reproduce all the result in a comnputing enviroment (supported by the amazing project mybinder.org)**
