...
```{r params, echo=print_code, message=FALSE, warning=FALSE}
# - inputs: none
...
call_params_f <- function(){
    ...
    ###### Data:
    ################ 
    # NEED TO ADD DATA SOURCES HERE: SCF, DINA, FORBES
    ...
    population_gr_so <- 0.01   # CBO/JCT AQUI VOY 
