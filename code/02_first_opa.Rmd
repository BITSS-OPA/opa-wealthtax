...
Three data sources were used in this analysis:   
 ...
 - Distributional National Accounts (DINA): estimates wealth by capitalizing investment income from income tax returns. The year available: 2019.    
 - Forbes 400:  provides the best estimate of billionares in the US. Last year available: 2018.  
...
2 - Go to [this link](https://mybinder.org/v2/gh/fhoces/opa-wealthtax/master?urlpath=rstudio) and reproduce all the result in a computing enviroment (supported by [project binder](mybinder.org)). You will **not** need to install anything in your computer.  
