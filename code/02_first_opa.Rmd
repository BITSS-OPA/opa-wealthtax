...
The combination of the `r paste("%",100*main_tax, sep = "")` tax above `r paste("$",starting_brack/1e6, sep = "")` million and the billionaire surtax would raise `r paste(round(tax_rev_init)," + ", round(top_tax_base), sep="")` = `r round(total_rev)` billion in 2019.  
...
This 10-year projection implies that revenue raised by the progressive wealth tax would be `r paste(ten_year_factor_round, " * ", round(total_rev), sep="")` = `r paste("$", ten_year_revenue, sep = "")` billion, rounded to `r paste("$", round(ten_year_revenue/1e3, 2) - adj_factor1_so, sep = "")` trillion. Out of these `r paste("$", round(ten_year_revenue/1e3, 2) - adj_factor1_so, sep = "")` trillion, the billionaire surtax would raise `r paste(round(top_tax_base), " * ", ten_year_factor_round, sep="")` = `r paste("$", round(ten_year_top_tax), sep ="")`, rounded to `r paste("$", round(ten_year_top_tax/1e3,1), sep ="")` trillion.  
